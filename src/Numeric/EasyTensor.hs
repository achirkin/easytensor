...
deriving instance Bounded (TT t n m) => Bounded (Tensor t n m)
deriving instance Enum (TT t n m) => Enum (Tensor t n m)
deriving instance Integral (TT t n m) => Integral (Tensor t n m)
deriving instance Real (TT t n m) => Real (Tensor t n m)
deriving instance RealFrac (TT t n m) => RealFrac (Tensor t n m)
deriving instance RealFloat (TT t n m) => RealFloat (Tensor t n m)
