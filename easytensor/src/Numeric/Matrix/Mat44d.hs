...
patV4 :: Vec4d -> (# Double, Double, Double, Double #)
patV4 (SingleFrame (DoubleX4# x y z w)) = (# D# x, D# y, D# z, D# w #)

patV3 :: Vec3d -> (# Double, Double, Double #)
patV3 (SingleFrame (DoubleX3# x y z)) = (# D# x, D# y, D# z #)
...
instance HomTransform4 Double where
  ...
  {-# INLINE toHomPoint #-}
  toHomPoint (SingleFrame (DoubleX3# x y z))
    = SingleFrame (DoubleX4# x y z 1.0##)

  {-# INLINE toHomVector #-}
  toHomVector (SingleFrame (DoubleX3# x y z))
    = SingleFrame (DoubleX4# x y z 0.0##)

  {-# INLINE fromHom #-}
  fromHom (SingleFrame (DoubleX4# x y z 0.0##))
    = SingleFrame (DoubleX3# x y z)
  fromHom (SingleFrame (DoubleX4# x y z w))
    = SingleFrame (DoubleX3# (x /## w) (y /## w) (z /## w))
